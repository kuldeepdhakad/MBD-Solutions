  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        accent:
          "bg-accent text-accent-foreground shadow-[0_4px_14px_-2px_rgba(30,115,255,0.35)] hover:bg-accent/90 hover:shadow-glow",
        outline:
          "border border-border bg-surface text-foreground shadow-soft hover:border-accent/40 hover:bg-panel hover:shadow-card",
        ghost: "text-foreground hover:bg-panel",
        whatsapp: "bg-[#25D366] text-white shadow-soft hover:bg-[#1ebe57] hover:shadow-card",
